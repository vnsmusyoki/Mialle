                    ...
                    <div class="theme-card">
                        <form class="theme-form" method="POST" autocomplete="off" action="">
                            ...
                            if (isset($_POST["register"])) {
                                require 'functions/buyer-register.php';
                            }
                            ?>
                            <?php echo $message ?>
                            ...
                            <div class="form-row row">
                                ...
                                <button type="submit" class="btn btn-solid w-auto" name="register">Create Customer Account</button>
                            </div>
                        </form>
                    </div>
                </div>
