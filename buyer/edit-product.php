                                ...
                                <div class="card-body product-box">
                                    <form action="" enctype="multipart/form-data" method="POST" action="">
                                        ...
                                        if (isset($_POST["uploadproduct"])) {
                                            require '../functions/customer/uploadeditedproduct.php';
                                        }
                                        ?>
                                        <?php echo $message ?>
                                        <div class="form-row row">
                                            <div class="col-md-6 mb-4">
                                                ...
                                                <input type="text" class="form-control" id="fname" placeholder="Write Product Name here" name="product_name" value="<?php echo $globalproductname; ?>" style="text-transform:capitalize;">
                                            </div>
                                            <br>
                                            <div class="col-md-6 mb-4">
                                                <label for="review">Product Price</label>
                                                <input type="number" min="1" class="form-control" id="lname" placeholder="Enter Product price" name="product_price" value="<?php echo $globalproductprice; ?>">
                                            </div>
                                            <br>
                                        </div>
                                        <div class="form-row row">
                                        ...
                                        <div class="form-row row mb-5">
                                            <div class="col-md-12">
                                                ...
                                                <textarea name="product_description" class="form-control" id="" cols="30" rows="10"><?php echo $globalproductdesc; ?></textarea>
                                            </div>
                                        ...
                                        <br>
                                        <button type="submit" class="btn btn-solid w-auto" name="uploadproduct">Upload Edited Product </button>
                                    </form>
                                </div>
                            </div>
                        </div>
