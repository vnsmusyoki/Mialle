                                ...
                                <div class="card-body order-datatable">
                                    <table class="display" id="basic-1">
                                        ...
                                        <tbody>
                                            ...
                                            $pickpoint = "SELECT * FROM pickup_points  WHERE `pickup_point_user_id`='$globalloggedinid' ";
                                            ...
                                            if ($querypickpointrows >= 1) {
                                                while ($fetch = mysqli_fetch_assoc($querypickpoint)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>1</td>
                                                        <td>$globallocation</td>
                                                        <td>$globalshopname</td> 
                                                         
                                                        <td><a href='update-station.php?station=$globalpointid' class='btn btn-warning'>Update </a></td>
