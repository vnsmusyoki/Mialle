                    ...
                    <div class="main-menu">
                        <div class="menu-left">
                            ...
                            <div class="brand-logo">
                                <a href="index.php"> <img src="customer/assets/images/dashboard/multikart-logos.png" class="img-fluid blur-up lazyload" alt=""></a>
                            </div>
                        </div>
                                ...
                                <nav id="main-nav">
                                    ...
                                    <ul id="main-menu" class="sm pixelstrap sm-horizontal">
                                        ...
                                        <li class="mega" id="hover-cls">
                                            <a href="all-products.php">All Products</a> </li>
                                     
                                        <li>
                                            <a href="seller-login.php">My Account</a> </li>
