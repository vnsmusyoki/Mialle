...
if (isset($_GET['product'])) {
    ...
    $checkemail = "SELECT *  FROM `users` WHERE `user_id` = '$globalproductuserid' ";
    $queryemail = mysqli_query($conn, $checkemail);
    $checkemailrows = mysqli_num_rows($queryemail);
    if ($checkemailrows >= 1) {
        while ($fetchcustomer = mysqli_fetch_assoc($queryemail)) {
            $globalname = $fetchcustomer['user_name'];
            $globalcontact = $fetchcustomer['user_contact'];
            $globallocation = $fetchcustomer['user_location'];
            $globalusercheck = $fetchcustomer['user_id'];
       $checkcustomer = "SELECT *  FROM `login` WHERE `login_id` = '$globalusercheck'";
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="header-contact text-end">
                                <ul>
                                    <li><i class="fas fa-truck" aria-hidden="true"></i>My Account</li>
                            ...
                            <div class="main-nav-center">
                                <nav class="text-start">
                                    ...
                                    <ul class="sm pixelstrap sm-horizontal">
                                        ...
                                        <li class="mega"><a href="all-products.php">All Products</a></li>
                                        <li><a href="all-others.php">Hot Deals</a></li>
                                        <li><a href="electronics.php">My Account</a> </li>
                                    </ul>
                                </nav>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="product-slick">
                            <div>
                                <img src="products/<?php echo $globalproductimage; ?>" alt="" class="img-fluid blur-up lazyload image_zoom_cls-0">
                            </div>
                        ...
                        <div class="row">
                            <div class="col-12 p-0">
                                <div class="slider-nav">
                                    <div><img src="products/<?php echo $globalproductimage; ?>" alt="" class="img-fluid blur-up lazyload"></div>
                    ...
                    <div class="col-lg-6 rtl-text">
                        <div class="product-right">
                            ...
                            <h3 class="price-detail">Kshs. <?php echo $globalproductprice; ?></h3>


                        </div>

                        <p style="line-height: 2;font-size:16px;"><?php echo $globalproductdesc; ?></p>
                        <a href="" class="btn btn-warning">Contact Seller - <?php echo $globalcontact; ?> </a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row row-cols-xxl-6 row-cols-xl-5 row-cols-lg-4 row-cols-md-3 row-cols-2 gy-sm-4 gy-3 ">
                ...
                if ($queryproductsrows >= 1) {
                    while ($fetch = mysqli_fetch_assoc($queryproducts)) {
                        ...
                        echo "
                        <div class='product-box product-wrap product-style-3 mt-5'>
                        <div class='img-wrapper'>
                            <div class='front'>
                                <a href='product-details.php?product=$productid'><img alt='' src='products/$image' class='img-fluid blur-up lazyload bg-img'></a>
                            </div>
                            <div class='cart-detail'><a href='product-details.php?product=$productid' title='Add to Wishlist'><i class='ti-heart' aria-hidden='true'></i></a> <a href='product-details.php?product=$productid'  title='Quick View'><i class='ti-search' aria-hidden='true'></i></a> <a href='product-details.php?product=$productid' title='Compare'><i class='ti-reload' aria-hidden='true'></i></a></div>
                        </div>
                        <div class='product-info'>
                            ...
                            <div class='add-btn'>
                                <a href='javascript:void(0)' class=''>
                                    <i class='ti-shopping-cart'></i>$categoryname - $subcategoryname
                                </a>
                            </div>
                        </div>
                    </div>
