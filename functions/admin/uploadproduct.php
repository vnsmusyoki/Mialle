                ...
                if ($filesize > 10000000) {
                    ...
                    if ($checkemailrows >= 1) {
                        while ($fetch = mysqli_fetch_assoc($queryemail)) {
                            ...
                            echo   $checkcustomer = "SELECT *  FROM `admin` WHERE `admin_login_id` = '$globalloggedinid'";
                    ...
                    echo $uploadimage = "INSERT INTO `products`(`product_name`, `product_description`, `product_price`, `product_user_id`, `product_images`, `product_category_id`, `product_sub_category_id`) VALUES ('$product_name', '$product_description','$product_price','$globaluserid','$filenamenew','$product_category','$product_sub_category')";
