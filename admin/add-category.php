                                    ...
                                    <form action="" enctype="multipart/form-data" method="POST" action="">
                                        ...
                                        if (isset($_POST["uploadproduct"])) {
                                            ...
                                            if (empty($category) || empty($description)) {
                                                ...
                                                $checkcategory = "SELECT *  FROM `categories` WHERE `category_name` = '$category'";
                                                ...
                                                if ($checkcategoryrows >= 1) {
                                                    ...
                                                    $addcat = "INSERT INTO `categories`(`category_name`, `category_desc`) VALUES ('$category', '$description')";
                                        ...
                                        <div class="form-row row">
                                            <div class="col-md-12 mb-4">
                                                ...
                                                <input type="text" class="form-control" id="fname" placeholder="Write Category Name here" name="category_name" value="<?php echo $category_name; ?>" style="text-transform:capitalize;">
                                            </div>
                                            <br>
                                        </div>
                                        <div class="form-row row mb-5">
                                            <div class="col-md-12">
                                                ...
                                                <textarea name="category_description" class="form-control" id="" cols="30" rows="10"><?php echo $category_description; ?></textarea>
                                            </div>
